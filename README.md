...
<br />
<br />
Next, it was revealed the native anti-virus idnetified a threat and performed actions on what it found. With that knowledge, I again researched Event IDs related to Windows Defender, and came accross two: 1116 and 1117. Within Splunk changing the source of logs to Windows Defender Operational with the Event ID 1116, I discovered Windows Defender detected the hack tool called SharpHound. With Evend ID 1117, it showed that 100% of actions performed by Windows Defenders were quarantining files and programs meaning that SharpHound was quarintined. <br/>
